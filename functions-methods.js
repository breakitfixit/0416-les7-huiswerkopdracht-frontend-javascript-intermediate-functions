...
// console.log(getEmailDomain("rick@gmail.com"));
// console.log(getEmailDomain("rick@hotmail.com"));
// console.log(getEmailDomain("rick@novi-education.nl"))
...
console.log(checkEmailValidity("n.eeken@novi.nl")); // true
console.log(checkEmailValidity("tessmellink@novi.nl")); // true
console.log(checkEmailValidity("n.eekenanovi.nl")); // false
console.log(checkEmailValidity("n.eeken@novinl.")); // false
console.log(checkEmailValidity("tessmellink@novi,nl")); // false
